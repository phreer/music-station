...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Example 1: Single Provider\n");
    {
        ...
        let query = LyricsQuery::new("Bohemian Rhapsody").with_artist("Queen");

        println!(
            "Searching for: {} by {}",
            query.title,
            query.artist.as_ref().unwrap()
        );
    ...
    {
        let provider1 = MockLyricsProvider::new("provider-1").add_lyrics(
            "Hotel California",
            "Eagles",
        ...
        let provider2 = MockLyricsProvider::new("provider-2").add_lyrics(
            "Stairway to Heaven",
            "Led Zeppelin",
        ...
        let query = LyricsQuery::new("Stairway to Heaven").with_artist("Led Zeppelin");
    ...
    {
        let provider1 = MockLyricsProvider::new("genius").add_lyrics(
            "Yesterday",
            "The Beatles",
        ...
        let provider2 = MockLyricsProvider::new("netease").add_lyrics(
            "Yesterday",
            "The Beatles",
        ...
        println!(
            "Searching all providers for: {} by {}",
            query.title,
            query.artist.as_ref().unwrap()
        );
    ...
    {
        let provider1 = MockLyricsProvider::new("healthy-provider").add_lyrics(
            "Test",
            "Test",
            "Test".to_string(),
            LyricFormat::Plain,
